...
public class Userdefineddateandtime {
	...
	public static void convertingDateandTimetoString() {
		System.out.println("");
		System.out.println("");
		System.out.println("");
		System.out.println("");
...
//        Date date = new Date();
	...
	public static void plusdays() {
		...
		// print instance
		System.out.println("LocalDate before" + " adding days: " + dateTimeFormatter.format(date));

		// adding dynamic values
		Scanner sc = new Scanner(System.in);
		System.out.println("Add  DAYS you want for  given date");
		int days = sc.nextInt();

		// add 5 days
		LocalDate returnvalue = date.plusDays(days);

		// print result
		System.out.println("LocalDate after 5 days" + " adding days: " + dateTimeFormatter.format(returnvalue));
...
//		creating local date object
		...
		System.out.println("LocalDate before" + " adding hours: " + formatter.format(currentDateTime));
...
//		adding number of hours to local object
		LocalDateTime returnvalue = currentDateTime.plusHours(hours);

		System.out.println("LocalDate after 5 days" + " adding days	: " + formatter.format(returnvalue));

	}

	public static void countTheDifference(String date1, String date2) {
		...
		years = ChronoUnit.YEARS.between(d1, d2);
		months = ChronoUnit.MONTHS.between(d1, d2);
		days = ChronoUnit.DAYS.between(d1, d2);
		hours = ChronoUnit.HOURS.between(d1, d2);
		minutes = ChronoUnit.MINUTES.between(d1, d2);
		seconds = ChronoUnit.SECONDS.between(d1, d2);
		System.out.println("difference between to dates are " + days);

		String Years = String.valueOf(ChronoUnit.YEARS.between(d1, d2));
//		String Months=String.valueOf()
	...
	public static void main(String[] args) {
		...
		datetimeformatteram();
		System.out.println(convertDateToString("2022-11-27"));
		...
		plushours();
		plusdays();
		countTheDifference("2022-12-20T15:22:22","2023-12-22T15:22:22");
