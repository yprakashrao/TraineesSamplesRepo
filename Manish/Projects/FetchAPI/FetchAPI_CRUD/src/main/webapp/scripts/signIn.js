...
// functions to hide and show form elements on login and signup
...
function getUID() {
  ...
  let promise3 = fetch("http://192.168.0.225:8080/Max_uID", {
    method: "GET",
  });
  promise3
    .then((response) => {
...
function addUser(bodydata) {
  ...
  let promise2 = fetch("http://192.168.0.225:8080/signup", {
    method: "POST",
    headers: {
