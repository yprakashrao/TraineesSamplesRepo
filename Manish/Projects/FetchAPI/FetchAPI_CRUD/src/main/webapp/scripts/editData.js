...
function editData(id) {
  ...
  let promise = fetch(`http://192.168.0.225:8080/Appointments/${id}`, {
    method: "GET",
  });
  ...
  promise
    ...
    .then((data) => {
      ...
      Fname1.value = data.firstname;
      Lname1.value = data.lastname;
      Age1.value = data.age;
      Phone1.value = data.phonenumber;
      Gender1.value = data.gender;
      Dates1.value = data.date;
      Time1.value = data.time;
      City1.value = data.city;
      Area1.value = data.area;
      Vacc1.value = data.vaccination_status;
      Symptoms1.value = data.symptoms;
      Addinfo1.value = data.add_info;
    });
}
